...
const techData: TechItemParams[] = [
    ...
    },
    {
        ...
        title: 'Figma',
        desc: 'Highly Accessible Versatile Graphic Design Tool',
        projects: [
            projectData.chemistreams,
            projectData.masquerades,
            projectData.hegemony,
    ...
    },
    {
        ...
        title: 'Tailwind',
        desc: 'Efficient Front End Visual Development Framework',
        projects: [
            projectData.masquerades,
            projectData.chemistreams,
        ],
    ...
    },
    {
        ...
        title: 'Mongo DB',
        desc: 'Blazing Fast Document-Oriented NoSQL Database',
        projects: [
            projectData.masquerades,
        ],
    },
